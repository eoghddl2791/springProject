...
public class ImageboardController {
	 ...
	 * 
	 * @ResponseBody public void imageboardWrite(@ModelAttribute ImageboardDTO imageboardDTO, @RequestParam MultipartFile img){ 
	 * String filePath = "C:\\java\\spring\\workSTS\\SpringProject\\src\\main\\webapp\\storage"; 
	...
	public ModelAndView imageboardWrite(@ModelAttribute ImageboardDTO imageboardDTO,
		...
		mav.addObject("display", "/imageboard/imageboardWrite.jap");
		mav.setViewName("/main/index");
		return mav;
	}
	*/
	
	//드래그해서 한번에 여러개의 파일을 선택할경우
	@RequestMapping(value="imageboardWrite", method=RequestMethod.POST)
	@ResponseBody
	...
	@ResponseBody
	public ModelAndView getImageList(@RequestParam String pg) {
